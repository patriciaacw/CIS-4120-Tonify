...
/*
// firebase imports if needed later
...
export default function App() {
  ...
  // 👇 show onboarding every time the app loads
  ...
  */
  ...
  // 👇 no localStorage: just close onboarding for this session
              ...
              <div className="bg-black rounded-[3rem] p-3 shadow-2xl">
                <div className="bg-white rounded-[2.5rem] overflow-hidden h-[844px] flex flex-col relative">
                  ...
                  >
                    <TabsContent
                        value="messages"
                        className="m-0 p-0 flex-1 min-h-0 overflow-hidden"
                    >
                      {selectedChatId ? (
